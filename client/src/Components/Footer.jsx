            ...
            <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10 py-14">
                ...
                <div className="flex flex-col md:flex-row items-center md:items-start justify-between gap-12">
                    ...
                    <div className="max-w-md text-center md:text-left">
                        ...
                        <Link to="/">
                            <div className="inline-block text-2xl sm:text-3xl font-bold tracking-wide cursor-pointer transition-all duration-300 hover:scale-105">
                        ...
                        <p className="mt-5 text-gray-400 leading-7 text-sm sm:text-base">
                            Crafting modern, responsive, and visually engaging
                            digital experiences with smooth interactions and
                    ...
                    <div className="flex flex-col items-center md:items-end">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <a
                                ...
                                className="group w-11 h-11 flex items-center justify-center rounded-full border border-slate-700 bg-slate-800/60 hover:bg-orange-500 hover:border-orange-500 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-orange-500/20 active:scale-95"
                            >
                                <svg
                            ...
                            {/* LinkedIn */}
                            <a
                                href="https://www.linkedin.com/in/gyanendra-aryal/"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="group w-11 h-11 flex items-center justify-center rounded-full border border-slate-700 bg-slate-800/60 hover:bg-orange-500 hover:border-orange-500 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-orange-500/20 active:scale-95"
                            >
                                <svg
                                    ...
                                    className="transition-transform duration-300 group-hover:scale-110"
                                >
                                    <path d="M4.98 3.5C4.98 4.88 3.86 6 2.48 6S0 4.88 0 3.5 1.12 1 2.48 1s2.5 1.12 2.5 2.5zM.5 8h4V24h-4V8zm7.5 0h3.8v2.16h.05c.53-1 1.84-2.16 3.8-2.16 4.07 0 4.82 2.68 4.82 6.16V24h-4v-7.1c0-1.7-.03-3.88-2.37-3.88-2.37 0-2.73 1.85-2.73 3.76V24h-4V8z" />
                                </svg>
                            </a>

                            {/* Instagram */}
                            <a
                                href="https://instagram.com/g_aryal5"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="group w-11 h-11 flex items-center justify-center rounded-full border border-slate-700 bg-slate-800/60 hover:bg-orange-500 hover:border-orange-500 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-orange-500/20 active:scale-95"
                            >
                ...
                {/* Bottom */}
                <div className="border-t border-slate-800 mt-12 pt-6 flex flex-col sm:flex-row items-center justify-center gap-4 text-sm text-gray-500">
                    <p>
                        © {new Date().getFullYear()} Gyanendra. All rights reserved.
                    </p>
                </div>
